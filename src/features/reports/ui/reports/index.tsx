    ...
    items: [
      {
        ...
        icon: Map,
        url: '/reports/applications-by-region',
        reportType: 'MONTHLY',
      },
      {
        id: 'rep-2',
        ...
        icon: PieChart,
        url: '/reports/applications-by-type',
        reportType: 'MONTHLY',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: PlusSquare,
        url: '/reports/registry-new-objects',
        reportType: 'MONTHLY',
      },
      {
        id: 'rep-8',
      ...
      },
      {
        ...
        icon: ClipboardCheck,
        url: '/reports/registry-deregistrations',
        reportType: 'MONTHLY',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: CalendarClock,
        url: '/reports/registry-equipment-terms',
        reportType: 'OTHERS',
      },
      {
