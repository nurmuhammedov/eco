import { CablewayIllegalAppealDtoSchema, RegisterIllegalCablewayAppApplicationDTO } from '@/entities/create-application'
...
export const useCreateIllegalCablewayApplication = () => {
  const form = useForm<RegisterIllegalCablewayAppApplicationDTO>({
    resolver: zodResolver(CablewayIllegalAppealDtoSchema),
    defaultValues: {
      phoneNumber: '',
