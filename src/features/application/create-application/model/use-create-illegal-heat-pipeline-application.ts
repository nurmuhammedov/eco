import {
  HeatPipelineIllegalAppealDtoSchema,
  RegisterIllegalHeatPipelineApplicationDTO,
...
export const useCreateIllegalHeatPipelineApplication = () => {
  const form = useForm<RegisterIllegalHeatPipelineApplicationDTO>({
    resolver: zodResolver(HeatPipelineIllegalAppealDtoSchema),
    defaultValues: {
      phoneNumber: '',
