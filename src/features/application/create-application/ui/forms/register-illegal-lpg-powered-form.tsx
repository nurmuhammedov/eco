...
import { CardForm, RegisterIllegalLpgPoweredAppApplicationDTO } from '@/entities/create-application';
import { NoteForm, useCreateIllegalLpgPoweredApplication } from '@/features/application/create-application';
...
interface RegisterIllegalLpgPoweredFormProps {
  onSubmit: (data: RegisterIllegalLpgPoweredAppApplicationDTO) => void;
}

export default ({ onSubmit }: RegisterIllegalLpgPoweredFormProps) => {
  const { form, regionOptions, districtOptions, childEquipmentOptions, hazardousFacilitiesOptions } =
    useCreateIllegalLpgPoweredApplication();

  return (
    <Form {...form}>
      <form autoComplete="off" onSubmit={form.handleSubmit(onSubmit)}>
        <GoBack title="Norasmiy yiliga 100 ming va undan ortiq kubometr tabiiy gazdan foydalanuvchi qurilmalarni ro‘yxatga olish" />
        ...
        <CardForm className="mb-2">
          <div className="md:grid md:grid-cols-2 xl:grid-cols-3 3xl:flex 3xl:flex-wrap gap-x-4 gap-y-5 4xl:w-5/5 mb-5">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Qurilma egasining nomi</FormLabel>
                  <FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Sarflash miqdori, m³/soat</FormLabel>
                  <FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Yoqilg‘i turi</FormLabel>
                  <FormControl>
              ...
              render={({ field }) => (
                <FormItem className={'mb-2'}>
                  <div className="flex items-end xl:items-center justify-between gap-2">
                    <FormLabel className="max-w-1/2 2xl:max-w-3/7">Qurilmaning birkasi bilan sur‘ati</FormLabel>
                    <FormControl>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="pb-4 border-b">
                <div className="flex items-end xl:items-center justify-between gap-2">
                  <FormLabel className="max-w-1/2 2xl:max-w-3/7">Gaz ta‘minoti loyihasi fayli</FormLabel>
                  <FormControl>
                    <InputFile form={form} name={field.name} accept={[FileTypes.PDF]} />
                  </FormControl>
                </div>
