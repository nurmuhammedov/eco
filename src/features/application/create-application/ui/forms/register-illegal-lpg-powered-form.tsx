...
import { CardForm, RegisterIllegalLpgPoweredDTO } from '@/entities/create-application'
...
const RegisterIllegalLpgPoweredForm = ({ onSubmit, isPending = false }: RegisterIllegalLpgPoweredFormProps) => {
  const {
    form,
    isUpdate,
    ...
    handleClear,
    handleSubmit,
  } = useRegisterIllegalLpgPowered(onSubmit)
        ...
        <CardForm className="mb-5 grid grid-cols-1 gap-x-8 gap-y-4 md:grid-cols-2 2xl:grid-cols-3">
          ...
          <div className="border-b pb-4">
            <DocumentField
              form={form}
              name="fullCheckPath"
              label="Texnik ko‘rikdan o‘tkazilganligi (sinovlar)"
              required={!isUpdate}
            />
            <FormField
              control={form.control}
...
export default RegisterIllegalLpgPoweredForm
