...
interface RegisterIllegalChemicalContainerFormProps {
  onSubmit: (data: RegisterIllegalChemicalContainerDTO) => void
  isPending?: boolean
}

const RegisterIllegalChemicalContainerForm = ({
  onSubmit,
  isPending = false,
}: RegisterIllegalChemicalContainerFormProps) => {
  const {
    form,
    isUpdate,
...
export default RegisterIllegalChemicalContainerForm
