...
import { useCreateIllegalChemicalContainerApplication } from '@/features/application/create-application/model/use-create-illegal-chemical-container-application.ts';
  ...
  return (
    <Form {...form}>
      <form autoComplete="off" onSubmit={form.handleSubmit(onSubmit)}>
        <GoBack title="Norasmiy bosim ostida ishlovchi idishlarni (kimyo) ro‘yxatga olish" />
