import { CardForm, CreateBoilerApplicationDTO } from '@/entities/create-application'
import { UserRoles } from '@/entities/user'
import { NoteForm, useCreateBoilerApplication } from '@/features/application/create-application'
...
interface RegisterBoilerFormProps {
  onSubmit: (data: CreateBoilerApplicationDTO) => void
}
    ...
    <Form {...form}>
      <form autoComplete="off" onSubmit={form.handleSubmit(onSubmit)}>
        ...
        <CardForm className="mb-2">
          <div className="3xl:flex 3xl:flex-wrap 4xl:w-5/5 mb-5 grid grid-cols-1 gap-x-4 gap-y-5 md:grid-cols-2 xl:grid-cols-3">
            <FormField
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel required>Qozonning zavod raqami</FormLabel>
                  <FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel required>Qozonni ishlab chiqargan zavod nomi</FormLabel>
                  <FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className={'mb-2'}>
                  <div className="flex flex-col justify-between gap-2 sm:flex-row sm:items-center">
                    <FormLabel required className="w-full sm:max-w-1/2 2xl:max-w-3/7">
                      Qozonning gidravlik sinovdan o‘tkazilganligi
                    </FormLabel>
                    <FormControl>
                      <InputFile form={form} name={field.name} accept={[FileTypes.PDF]} />
                    </FormControl>
