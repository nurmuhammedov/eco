  ...
  return (
    <Form {...form}>
      <form autoComplete="off" onSubmit={form.handleSubmit(onSubmit)}>
        <GoBack title="Norasmiy atraksion pasportini ro‘yxatga olish" />
        ...
        <CardForm className="my-2">
          <div className="md:grid md:grid-cols-2 xl:grid-cols-3 3xl:flex 3xl:flex-wrap gap-x-4 gap-y-5 4xl:w-5/5 mb-5">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Attraksion tipi</FormLabel>
                  <FormControl>
                    <Select
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Xizmat muddati (yil)</FormLabel>
                  <FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Attraksionning biomexanik xavf darajasi (toifa)</FormLabel>
                  <FormControl>
        ...
        <CardForm className="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 gap-x-8 gap-y-4 mb-5">
              ...
              render={({ field }) => (
                <FormItem className={'mb-2'}>
                  <div className="flex items-end xl:items-center justify-between gap-2">
                    <FormLabel>Attraksionning birkasi bilan surati</FormLabel>
                    <FormControl>
          ...
          <div className="pb-4 border-b">
            <FormField
              ...
              render={({ field }) => (
                <FormItem className={'mb-2'}>
                  <div className="flex items-end xl:items-center justify-between gap-2">
                    <FormLabel>Attraksion pasporti fayli</FormLabel>
                    <FormControl>
          ...
          <div className="pb-4 border-b">
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="mb-2">
                  <div className="flex items-end xl:items-center justify-between gap-2">
                    <FormLabel>Attraksion sertifikati fayli</FormLabel>
                    <FormControl>
                      <InputFile form={form} name={field.name} accept={[FileTypes.PDF]} />
                    </FormControl>
                  </div>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className={'mb-2'}>
                <div className="flex items-end xl:items-center justify-between gap-2">
                  <FormLabel>Attraksionni foydalanishga qabul qilish guvohnomasi fayli</FormLabel>
                  <FormControl>
                    <InputFile form={form} name={field.name} accept={[FileTypes.PDF]} />
                  </FormControl>
                </div>
          ...
          <div className="pb-4 border-b">
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="mb-2">
                  <div className="flex items-end xl:items-center justify-between gap-2">
                    <FormLabel>Masʼul shaxs tayinlanganligi toʻgʻrisida buyruq fayli</FormLabel>
                    <FormControl>
                      <InputFile form={form} name={field.name} accept={[FileTypes.PDF]} />
                    </FormControl>
                  </div>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="pb-4 border-b">
                <div className="flex items-end xl:items-center justify-between gap-2">
                  <FormLabel>Attraksion texnik tayyorligi toʻgʻrisida dalolatnoma</FormLabel>
                  <FormControl>
                    <InputFile form={form} name={field.name} accept={[FileTypes.PDF]} />
                  </FormControl>
                </div>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="pb-4 border-b">
                <div className="flex items-end xl:items-center justify-between gap-2">
                  <FormLabel>Attraksion mavsumga tayyorligi toʻgʻrisida dalolatnoma</FormLabel>
                  <FormControl>
                    <InputFile form={form} name={field.name} accept={[FileTypes.PDF]} />
                  </FormControl>
                </div>
