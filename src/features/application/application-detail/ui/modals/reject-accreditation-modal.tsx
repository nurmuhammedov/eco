...
const RejectAccreditationModal = () => {
  ...
  const {
    ...
    pdfEndpoint: '/accreditations/cancel/generate-pdf',
    submitEndpoint: '/accreditations/cancel',
...
export default RejectAccreditationModal
