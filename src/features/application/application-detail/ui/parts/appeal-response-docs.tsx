...
import RejectMessageModal from '@/features/application/application-detail/ui/modals/reject-message-modal'
...
import ConfirmWithRegistryModal from '../modals/confirm-with-registry-modal'
