...
const FilesSection: FC<Props> = ({ files, userRole, applicationStatus, appealId }) => {
  const canEdit = userRole === UserRoles.INSPECTOR && applicationStatus === ApplicationStatus.IN_PROCESS;
      ...
      {files.map((file) => (
        <div key={file.path} className="flex justify-between items-center border-b border-b-[#E5E7EB] py-4 px-3">
          ...
          <div className="flex items-center gap-2">
            {file.path && <FileLink url={file.path} />}
