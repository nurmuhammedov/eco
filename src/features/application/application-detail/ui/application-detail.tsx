...
const ApplicationDetail = ({data}: any) => {
    ...
    return (
        <div className="grid grid-cols-1 gap-4 mt-4">
            <DetailCardAccordion
                defaultValue={['general', 'applicant_info_individual', 'applicant_info_legal', 'appeal_docs', 'appeal_files', 'appeal_location']}>
                ...
                <DetailCardAccordion.Item value="general" title="Ariza va ijro to‘g‘risida maʼlumot">
                    <div className="py-1 px-2 flex flex-col">
                        ...
                        />
                        <DetailRow title="Ariza holati:"
                                   value={<Stepper
                                       activeStep={data?.status}
                                       steps={Object.values(ApplicationStatus).slice(1, -1)}/>}/>
                ...
                {!isLegalApplication &&
                    <DetailCardAccordion.Item value="applicant_info_individual"
                ...
                {isLegalApplication &&
                    <DetailCardAccordion.Item value="applicant_info_legal"
                                              title="Arizachi to‘g‘risida ma’lumot">
                        <LegalApplicantInfo tinNumber={data?.legalTin}/>
                    </DetailCardAccordion.Item>}
                <DetailCardAccordion.Item value="appeal_docs"
                                          title="Ariza bo‘yicha batafsil ma’lumotlar va hujjatlar">
                ...
                <DetailCardAccordion.Item value="appeal_files"
                                          title="Arizaga biriktirilgan fayllar">
                    FILES_SECTION
                </DetailCardAccordion.Item>
                <DetailCardAccordion.Item value="appeal_location"
                                          title="Arizada ko‘rsatilgan obyekt yoki qurilma joyi">
