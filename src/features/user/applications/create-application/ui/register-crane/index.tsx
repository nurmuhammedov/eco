      ...
      <CardForm className="my-2">
        <div className="md:grid md:grid-cols-2 xl:grid-cols-3 3xl:flex 3xl:flex-wrap gap-x-4 gap-y-5 4xl:w-5/5 mb-5">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="w-full 3xl:w-sm">Стреласининг узинлиги</FormLabel>
                <FormControl>
                  <Input
                    min={1}
                    type="number"
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input min={1} type="number" className="w-full 3xl:w-sm" placeholder="Yuk ko'tara olish" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
      ...
      <CardForm className="grid grid-cols-2 2xl:grid-cols-3 gap-x-8 gap-y-4">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="pb-4 border-b">
              <div className="flex items-end xl:items-center justify-between gap-2">
                <FormLabel className="max-w-1/2 2xl:max-w-3/7">Монтаж гувоҳномаси файли(автокрандан ташқари)</FormLabel>
                <FormControl>
                  <InputFile form={form} accept={[FileTypes.PDF]} {...field} />
                </FormControl>
              </div>
