...
export default function LoginForm() {
  ...
  return (
    <div className="w-1/2 flex flex-col items-center justify-center">
      ...
      <a
        href={`https://sso.egov.uz/sso/oauth/Authorization.do?response_type=one_code&client_id=ekotizim_cirns_uz&client_secret=rfxcTm2qC69r0Ar29Gjw286Z&redirect_uri=https://ekotizim.cirns.uz/auth/login&scope=myportal&state=testState`}
