...
export default function LoginForm() {
  ...
  return (
    <div className="w-1/2 flex flex-col items-center justify-center">
      ...
      <a
        href={`https://sso.egov.uz/sso/oauth/Authorization.do?response_type=one_code&client_id=ysn_uztn_uz&redirect_uri=https://ekotizim.technocorp.uz/auth/login&scope=myportal&state=testState`}
