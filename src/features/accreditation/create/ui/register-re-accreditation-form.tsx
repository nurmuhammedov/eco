// src/features/accreditation/create/ui/register-re-accreditation-form.tsx
...
import { useReRegisterAccreditation } from '../model/use-re-register-accreditation.ts';

export const RegisterReAccreditationForm = () => {
  const {
    form,
    onSubmit,
    isLoading,
