      ...
      <div className="space-y-4">
        ...
        {isLoading ? (
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            {[...Array(3)].map((_, i) => (
              <div key={i} className="h-[200px] animate-pulse rounded-lg border border-gray-200 bg-gray-50" />
            ))}
          </div>
          ...
          <div className="3xl:grid-cols-4 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
