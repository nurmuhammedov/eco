...
const DeclarationFileUploadModal: FC<Props> = ({ id, closeModal, title = 'Deklaratsiya faylini yuklash' }) => {
  const form = useForm<z.infer<typeof schema>>({
    resolver: zodResolver(schema),
  })
  const qc = useQueryClient()

  const { mutateAsync, isPending } = useAdd(`/declarations/${id}/file`)
...
export default DeclarationFileUploadModal
