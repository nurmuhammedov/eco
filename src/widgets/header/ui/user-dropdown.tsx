...
export default function UserDropdown() {
  ...
  return (
    <>
        ...
        <DropdownMenuContent className="w-56" align="end">
          ...
          <DropdownMenuGroup>
            ...
            {user?.role === UserRoles.INDIVIDUAL && (
              <DropdownMenuItem className="flex cursor-pointer items-center" onClick={() => setIsCardsModalOpen(true)}>
      ...
      {user?.role === UserRoles.INDIVIDUAL && (
        <MyCardsModal open={isCardsModalOpen} onOpenChange={setIsCardsModalOpen} />
      )}
    </>
  )
}
