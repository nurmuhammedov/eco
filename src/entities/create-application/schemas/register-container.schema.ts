...
const __ContainerAppealDtoSchema = z.object({
  ...
  partialCheckDate: z.date().transform((date) => format(date, 'yyyy-MM-dd')), // Tashqi va ichki ko‘rik
  fullCheckDate: z.date().transform((date) => format(date, 'yyyy-MM-dd')), // Gidrosinov
