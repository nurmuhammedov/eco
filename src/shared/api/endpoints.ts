...
export const API_ENDPOINTS: Record<string, string> = {
  ...
  APPEAL_EQUIPMENT_OIL_CONTAINER: APPEALS_EQUIPMENT_URL + 'oil-container',
  APPEAL_EQUIPMENT_UNOFFICIAL_OIL_CONTAINER: '/appeals/equipment/unofficial/oil-container',
