...
export const API_ENDPOINTS: Record<string, string> = {
  ...
  APPEAL_EQUIPMENT_UNOFFICIAL_OIL_CONTAINER: APPEALS_EQUIPMENT_URL + 'unofficial/oil-container',
  ...
  APPEAL_EQUIPMENT_PDF_UNOFFICIAL_OIL_CONTAINER:
    APPEALS_EQUIPMENT_GENERATE_PDF_URL + 'unofficial/generate-pdf/oil-container',
