export const riskAnalysisData = {
  hf: [
    {
      title:
        'Havfli ishlab chiqarish obyektlari loyihaviy hujjatlarining sanoat xavfsizligi ekspertizasidan o‘tkazilganligi, identifikatsiya xulosasi, sanoat xavfsizligi deklaratsiyasi, majburiy sug‘urta mavjudligi',
      point: 13,
      rejectPlaceholder: 'Izoh',
    },
    {
      title:
        'Havfli ishlab chiqarish obyektlari litsenziyalash yoki ruxsat etish xususiyatiga ega hujjatlarni rasmiylashtirmaslik yoki muddatiga amal qilmaslik',
      point: 2,
      rejectPlaceholder:
        'Tashkilotning litsenziyasi yo‘q, ruxsatnoma muddati o‘tib ketgan. Litsenziya muddatini uzaytirish kerak.',
    },
    {
      title:
        'Havfli ishlab chiqarish obyektlarini davlat reyestriga kiritilganligi, ishlab chiqarish nazorati tashkil etilganligi, texnik qurilmalar ro‘yxatga olinganligi va pasporti mavjudligi',
      point: 14,
      rejectPlaceholder: 'Ma’lumot taqdim etilmagan',
    },
    {
      title:
        'Havfli ishlab chiqarish obyektida qo‘llaniladigan texnik qurilmalarni ekspertizadan o‘tkazilganligi (texnik qurilmani konstruksiyasiga o‘zgartirish kiritilganda yoki xizmat muddati tugagan bo‘lsa)',
      point: 6,
      rejectPlaceholder: 'Qurilmalar pasporti mavjud emas',
    },
    {
      title: 'Texnik xavf ko‘rgan bo‘lgan zonalar davlat kadastri ishlab chiqilganligi',
      point: 10,
      rejectPlaceholder: 'TXKZ dastur pasporti mavjud emas',
    },
    {
      title:
        'Havfli ishlab chiqarish obyektlaridan foydalanuvchi tashkilotlarning rahbar va muhandis-texnik xodimlarini tayyorlash, qayta tayyorlash, ularning malakasini oshirish hamda attestatsiyadan o‘tkazilganligi',
      point: 12,
      rejectPlaceholder: 'Xodimlar attestatsiyadan o‘tmagan',
    },
    {
      title: 'Ishchi xodimlarning maxsus kiyim-bosh bilan ta’minlanganligi',
      point: 1,
      rejectPlaceholder: 'Ishchilar kaskalar bilan ta’minlanmagan',
    },
    {
      title:
        'Havfli ishlab chiqarish obyektda avariya, noxush hodisalar (incident) hamda baxtsiz hodisalar holatlari sodir bo‘lganligi',
      point: 6,
      rejectPlaceholder: '12.12.2024 kuni baxtsiz hodisa ro‘y bergan',
    },
    {
      title: 'Normativ-huquqiy va normativ-texnik hujjatlar talablari buzilishi',
      point: 15,
      rejectPlaceholder: 'Hujjatlar va ma’lumotnoma taqdim etilmagan',
    },
    {
      title: 'Texnik jihatdan tartibga solish sohasidagi normativ hujjatlar talablari buzilishi',
      point: 15,
      rejectPlaceholder: 'Normativ hujjatlar talablari buzilgan, -son qaror, -bandi',
    },
    {
      title:
        'Qo‘mitaning o‘z faoliyatini amalga oshirishi uchun vakolat doirasida so‘ralgan axborotlar, hujjatlar, ma’lumotnomalar va boshqa materiallarni taqdim etmaslik, o‘z vaqtida yoki qisman taqdim etmaslik',
      point: 6,
      rejectPlaceholder: 'Ma’lumot taqdim etilmagan',
    },
  ],
  ...
  attraction: [
    ...
    {
      title: `Attraktsionlarni soz holatda saqlash va xavfsiz foydalanish uchun mas'ul bo‘lgan shaxs mavjudligi`,
      point: 15,
      rejectPlaceholder: `placeholder`,
    },
    {
      title: `Mavsum oldidan attraktsionlarni to‘liq texnik shahodat sinovlaridan o‘tganligi`,
      point: 15,
      rejectPlaceholder: `placeholder`,
    },
    {
    ...
    {
      title: `Attraktsionlarga texnik xizmat ko‘rsatish kundalik, davriy va mavsumiy profilaktika ishlari bajarilganligi`,
      point: 15,
      rejectPlaceholder: `placeholder`,
    },
    {
      title: `Normativ-huquqiy hujjatlar va texnik jihatdan tartibga solish sohasidagi normativ hujjatlar talablari buzilishi`,
      point: 15,
      rejectPlaceholder: `placeholder`,
    },
    {
  ...
  elevator: [
    ...
    {
      title: `Liftning texnik pasporti mavjudligi`,
      point: 15,
      rejectPlaceholder: `placeholder`,
    },
    {
    ...
    {
      title: `Lift dispetcher tizimiga ulanganligi va sozligi`,
      point: 15,
      rejectPlaceholder: `placeholder`,
    },
    {
      title: `Lift nuqsonlarni ko‘rsatish tizimi sozligi`,
      point: 15,
      rejectPlaceholder: `placeholder`,
    },
    {
      title: `Liftlarni davlat reestirida ro‘yxatga olinganligi`,
      point: 15,
      rejectPlaceholder: `placeholder`,
    },
    {
